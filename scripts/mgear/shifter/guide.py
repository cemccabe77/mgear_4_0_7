...
class Rig(Main):
    ...
    def addParameters(self):
        ...
        #cm
        self.pBypass = self.addParam("bypass", "bool", False)
...
class GuideSettings(MayaQWidgetDockableMixin, QtWidgets.QDialog, HelperSlots):
    ...
    def populate_controls(self):
        ...
        self.populateCheck(self.guideSettingsTab.encoreBypass_checkBox, "bypass")
    ...
    def create_connections(self):
        ...
        # custom Step Tab
        #cm
        tap.encoreBypass_checkBox.stateChanged.connect(
            partial(self.updateCheck,
                    tap.encoreBypass_checkBox,
                    "bypass"))
