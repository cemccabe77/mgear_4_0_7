...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pGlobs = self.addParam("globalScale", "bool", False)
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        self.populateCheck(self.settingsTab.globalScale_checkBox, "globalScale")
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.uniScale_checkBox.stateChanged.connect(
            partial(self.updateCheck,
                    ...
                    "uniScale"))
        self.settingsTab.globalScale_checkBox.stateChanged.connect(
            partial(self.updateCheck,
                    self.settingsTab.globalScale_checkBox,
                    "globalScale"))
