...
# Form implementation generated from reading ui file 'D:/Working/cmlib/cmMayaWorkgroup2020/mGear/scripts/mgear/shifter_classic_components/control_multi_01/settingsUI.ui',
# licensing of 'D:/Working/cmlib/cmMayaWorkgroup2020/mGear/scripts/mgear/shifter_classic_components/control_multi_01/settingsUI.ui' applies.
#
# Created: Wed Sep  1 12:10:27 2021
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.numofctl_label = QtWidgets.QLabel(self.groupBox)
        self.numofctl_label.setObjectName("numofctl_label")
        self.horizontalLayout_31.addWidget(self.numofctl_label)
        self.numofctl_SpinBox = QtWidgets.QSpinBox(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.numofctl_SpinBox.sizePolicy().hasHeightForWidth())
        self.numofctl_SpinBox.setSizePolicy(sizePolicy)
        self.numofctl_SpinBox.setWrapping(False)
        self.numofctl_SpinBox.setAlignment(QtCore.Qt.AlignCenter)
        self.numofctl_SpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        self.numofctl_SpinBox.setMinimum(0.0)
        self.numofctl_SpinBox.setMaximum(20000.0)
        self.numofctl_SpinBox.setProperty("value", 0.0)
        self.numofctl_SpinBox.setObjectName("numofctl_SpinBox")
        self.horizontalLayout_31.addWidget(self.numofctl_SpinBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.numofctl_label.setText(QtWidgets.QApplication.translate("Form", "Num of Ctl", None, -1))
