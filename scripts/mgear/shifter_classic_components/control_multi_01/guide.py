...
EMAIL = ""
VERSION = [1, 3, 0]
TYPE = "control_multi_01"
NAME = "controlmulti"
DESCRIPTION = "Multiple, simple controllers with space switch and Rot order selection. \n"\
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        #self.pJoint = self.addParam("joint_per_ctl", "bool", False)
        ...
        self.pNumofCtl = self.addParam("numofctl", "long", 0, None, None)
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        #self.populateCheck(self.settingsTab.joint_per_ctl_checkBox, "joint_per_ctl")
        ...
        self.settingsTab.numofctl_SpinBox.setValue(
            self.root.attr("numofctl").get())
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.joint_checkBox.stateChanged.connect(
            partial(self.updateCheck,
                    ...
                    "joint"))
        '''
        self.settingsTab.joint_per_ctl_checkBox.stateChanged.connect(
            partial(self.updateCheck,
                    self.settingsTab.joint_per_ctl_checkBox,
                    "joint_per_ctl"))
        '''
        ...
        self.settingsTab.ctlSize_doubleSpinBox.valueChanged.connect(
            partial(self.updateSpinBox,
                    ...
                    "ctlSize"))
        self.settingsTab.numofctl_SpinBox.valueChanged.connect(
            partial(self.updateSpinBox,
                    self.settingsTab.numofctl_SpinBox,
                    "numofctl"))
