"""Component Leg 3 joints 02 module"""
...
class Component(component.Main):
    ...
    def addObjects(self):
        ...
        self.match_fk2_off = self.add_match_ref(self.fk_ctl[3],
                                                self.root,
                                                "matchFk2_npo",
                                                False)
        ...
        self.match_fk3 = self.add_match_ref(self.fk_ctl[3],
                                            self.ik_ctl,
                                            "fk3_mth")
    ...
    def addAttributes(self):
        ...
        self.fullIK_attr = self.addAnimParam(
            ...
            "Full 3 bones IK",
            "double",
            self.settings["full3BonesIK"], 0, 1)
        ...
        self.kneeFlipOffset_att = self.addSetupParam("kneeFlipOffset",
                                                     "Knee Flip Offset",
                                                     "double",
                                                     defValu,
                                                     -180,
        ...
        self.ankleFlipOffset_att = self.addSetupParam("ankleFlipOffset",
                                                      "Ankle Flip Offset",
                                                      "double",
                                                      defValu,
                                                      -180,
    ...
    def addOperators(self):
        ...
        if self.settings["globScl"]==True:
            pm.connectAttr('global_C0_ctl' + ".scale", self.setup + ".scale")
        else:
