...
class Component(component.Main):
    ...
    def addObjects(self):
        ...
        if self.settings['isUiHost']:
            pm.addAttr(self.ctl, at='bool', sn='isUiHost', k=False, dv=True)

        if self.settings['uiHostType']:
            pm.addAttr(self.ctl, dt='string', sn='uiHostType', k=False)
            pm.setAttr(self.ctl+'.uiHostType', self.settings['uiHostType'], typ='string')
