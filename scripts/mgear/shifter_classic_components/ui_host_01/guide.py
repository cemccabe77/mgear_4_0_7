...
TYPE = "ui_host_01"
NAME = "uiHost"
DESCRIPTION = "Simple controller used for hosting component settings. \n"\
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pIcon = self.addParam("icon", "string", "cross")
        ...
        self.pIsUiHost = self.addParam("isUiHost", "bool", True)
        self.pUiHostTyp = self.addParam("uiHostType", "string", "misc")
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def __init__(self, parent=None):
        ...
        self.hostTypeList = ['arm','leg','spine','face', 'cape', 'tail', 'wing', 'car', 'misc']
    ...
    def populate_componentControls(self):
        ...
        # self.settingsTab.uiType_comboBox.setCurrentIndex(0)
        self.settingsTab.uiType_comboBox.setCurrentIndex(self.hostTypeList.index(self.root.attr("uiHostType").get()))
        # self.settingsTab.controlShape_comboBox.setCurrentIndex(3)
        self.settingsTab.controlShape_comboBox.setCurrentIndex(self.iconsList.index(self.root.attr("icon").get()))
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.controlShape_comboBox.currentIndexChanged.connect(
            partial(self.updateControlShape,
                    ...
                    self.iconsList, "icon"))
        self.settingsTab.uiType_comboBox.currentIndexChanged.connect(
            partial(self.updateControlShape,
                    self.settingsTab.uiType_comboBox,
                    self.hostTypeList, "uiHostType"))
