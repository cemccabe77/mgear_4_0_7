...
TYPE = "control_sdk_01"
NAME = "control"
DESCRIPTION = "control 01 with added groups above the main control \n"\
              "This component should be used when Set driven keys are  "\
              "required such as in sdk transfomation rigs \n\n" \
...
class Guide(guide.ComponentGuide):
    ...
    # @param self
    def postInit(self):
        self.save_transform = ["root", "sizeRef"] # , "sdk_groups"
        #if self.compType == "control_sdk_01":
    ...
    def addParameters(self):
        ...
        self.pExtraGroup_number = self.addParam("extraGroup_number", "long", 0, None, None)
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        self.settingsTab.extraGroup_number_SpinBox.setValue(
            self.root.attr("extraGroup_number").get())
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.extraGroup_number_SpinBox.valueChanged.connect(
            partial(self.updateSpinBox,
                    self.settingsTab.extraGroup_number_SpinBox,
                    "extraGroup_number"))
